...
# 第一轮面试结果
FIRSI_INTERVIEW_RESULT_TYPE = ((u'建议复试', '建议复试'), (u'待定', u'待定'), (u'放弃', u'放弃'))
...
class Candidate(models.Model):
    ...
    master_school = models.CharField(max_length=135, blank=True, verbose_name="硕士生学校")
    ...
    # 第一轮面试记录
    first_score = models.DecimalField(decimal_places=1, null=True, max_digits=2, blank=True, verbose_name="初试得分")
    ...
    first_result = models.CharField(max_length=256, choices=FIRSI_INTERVIEW_RESULT_TYPE, blank=True,
                                    verbose_name="初试结果")
    first_recommend_position = models.CharField(max_length=256, blank=True, verbose_name="建议方向或推荐部门")
    ...
    second_remark = models.CharField(max_length=135, blank=True, verbose_name="复试备注")
    ...
    hr_communicatiojn_ability = models.CharField(max_length=10, choices=HR_SCORE_TYPE, blank=True,
                                                 verbose_name="HR坦诚沟通")
    ...
    # 定义__str__()方法，系统使用这个方法来把对象转换成字符串
    def __str__(self):
