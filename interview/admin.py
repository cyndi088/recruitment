...
class CandidateAdmin(admin.ModelAdmin):
    ...
    list_display = (
        ...
        'second_score', 'second_result', 'second_interviewer', 'hr_score', 'hr_result', 'last_editor'
    )
    ...
    fieldsets = (
        (None, {'fields': ("userid", "apply_position", ("username", "city", "phone", "email"),
        ...
        ('初试面试记录', {'fields': (("first_score", "first_learning_ability", "first_professional_competency"),
        ...
        ('HR面试记录', {'fields': ("hr_score", ("hr_responsibility", "hr_communicatiojn_ability", "hr_logic_ability",
